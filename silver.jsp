		 ...
		 <center>
            ...
            <div class="col-lg-2 col-md-6 col-xs-6 thumb">
                <a class="thumbnail" href="#">
                    <img class="img-responsive" src="<c:url value='resources/silver/1.1.jpg'/>"/>	
            ...
            <div class="col-lg-2 col-md-6 col-xs-6 thumb">
                <a class="thumbnail" href="#">
                    <img class="img-responsive" src="<c:url value='resources/silver/10.10.jpg'/>"/>
                    Product name: Audi A8<br>
                   Product Price: 5,00,000/-<br>
                   <input type="submit" value="Description" />
                </a>
            ...
            <div class="col-lg-2 col-md-6 col-xs-6 thumb">
                <a class="thumbnail" href="#">
                    <img class="img-responsive" src="<c:url value='resources/silver/2.2.jpg'/>"/>
                    Product name: Audi A8<br>
                   Product Price: 5,00,000/-<br>
                   <input type="submit" value="Description" />
                </a>
            ...
            <div class="col-lg-2 col-md-6 col-xs-6 thumb">
                <a class="thumbnail" href="#">
                    <img class="img-responsive" src="<c:url value='resources/silver/9.9.jpg'/>"/>
                    Product name: Audi A8<br>
                   Product Price: 5,00,000/-<br>
                   <input type="submit" value="Description" />
                </a>
            ...
            <div class="col-lg-2 col-md-6 col-xs-6 thumb">
                <a class="thumbnail" href="#">
                    <img class="img-responsive" src="<c:url value='resources/silver/3.3.jpg'/>"/>
                    Product name: Audi A8<br>
                   Product Price: 5,00,000/-<br>
                   <input type="submit" value="Description" />
                </a>
            ...
            <div class="col-lg-2 col-md-6 col-xs-6 thumb">
                <a class="thumbnail" href="#">
                    <img class="img-responsive" src="<c:url value='resources/silver/8.8.jpg'/>"/>
                    Product name: Audi A8<br>
                   Product Price: 5,00,000/-<br>
                   <input type="submit" value="Description" />               
                </a>
            ...
            <div class="col-lg-2 col-md-6 col-xs-6 thumb">
                <a class="thumbnail" href="#">
                    <img class="img-responsive" src="<c:url value='resources/silver/4.4.jpg'/>"/>
                   Product name: Audi A8<br>
                   Product Price: 5,00,000/-<br>
                   <input type="submit" value="Description" />
                </a>
            ...
            <div class="col-lg-2 col-md-6 col-xs-6 thumb">
                <a class="thumbnail" href="#">
                    <img class="img-responsive" src="<c:url value='resources/silver/7.7.jpg'/>"/>
                    Product name: Audi A8<br>
                   Product Price: 5,00,000/-<br>
                   <input type="submit" value="Description" />
                </a>
            ...
            <div class="col-lg-2 col-md-6 col-xs-6 thumb">
                <a class="thumbnail" href="#">
                    <img class="img-responsive" src="<c:url value='resources/silver/5.5.jpg'/>"/>
                    Product name: Audi A8<br>
                   Product Price: 5,00,000/-<br>
                   <input type="submit" value="Description" />
                </a>
			...
			<div class="col-lg-2 col-md-6 col-xs-6 thumb">
                <a class="thumbnail" href="#">
                    <img class="img-responsive" src="<c:url value='resources/silver/6.6.jpg'/>"/>
                    Product name: Audi A8<br>
                   Product Price: 5,00,000/-<br>
                   <input type="submit" value="Description" />
                </a>
