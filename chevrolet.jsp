...
<center>Chevrolet Models</center>			
        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-6 col-xs-6 thumb">
                <a class="thumbnail" href="#">
                    <img class="img-responsive" src="<c:url value='resources/Chevrolet/1.jpg'/>"/>
            ...
            <div class="col-lg-2 col-md-6 col-xs-6 thumb">
                <a class="thumbnail" href="#">
                    <img class="img-responsive" src="<c:url value='resources/Chevrolet/2.jpg'/>"/>
                    Product name: Audi A8<br>
                   Product Price: 5,00,000/-<br>
                   <input type="submit" value="Description" />
                </a>
            ...
            <div class="col-lg-2 col-md-6 col-xs-6 thumb">
                <a class="thumbnail" href="#">
                    <img class="img-responsive" src="<c:url value='resources/Chevrolet/3.jpg'/>"/>
                     Product name: Audi A8<br>
                   Product Price: 5,00,000/-<br>
                   <input type="submit" value="Description" />
                </a>
            ...
            <div class="col-lg-2 col-md-6 col-xs-6 thumb">
                <a class="thumbnail" href="#">
                    <img class="img-responsive" src="<c:url value='resources/Chevrolet/4.jpg'/>"/>
                    Product name: Audi A8<br>
                   Product Price: 5,00,000/-<br>
                   <input type="submit" value="Description" />
                </a>
            ...
            <div class="col-lg-2 col-md-6 col-xs-6 thumb">
                <a class="thumbnail" href="#">
                    <img class="img-responsive" src="<c:url value='resources/Chevrolet/5.jpg'/>"/>
                    Product name: Audi A8<br>
                   Product Price: 5,00,000/-<br>
                   <input type="submit" value="Description" />
                </a>
            ...
            <div class="col-lg-2 col-md-6 col-xs-6 thumb">
                <a class="thumbnail" href="#">
                    <img class="img-responsive" src="<c:url value='resources/Chevrolet/6.jpg'/>"/>
                    Product name: Audi A8<br>
                   Product Price: 5,00,000/-<br>
                   <input type="submit" value="Description" />
                </a>
